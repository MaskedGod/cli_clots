...
from .config import (SYMBOLS, NUM_REELS, VISIBLE_ROWS, PAYLINES,
                    MIN_BET, MAX_BET, INITIAL_BALANCE)
...
class SlotMachine:
    ...
    def _generate_reels(self) -> List[List[str]]:
        ...
        return [[choice(self.symbols) for _ in range(VISIBLE_ROWS)] for _ in range(NUM_REELS)]
